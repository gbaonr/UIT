...
tuple<vector<int>, vector<int>, int> dijkstra(int n, vector<vector<int>> g, int s, int d)
{
    ...
    priority_queue<pair<int, int>, vector<pair<int, int>>, decltype(customSort)> pq(customSort);
    ...
    while (!pq.empty()) {
        ...
        cout << "\n-----\n";
        priority_queue<pair<int, int>, vector<pair<int, int>>, decltype(customSort)> pq2(customSort) = pq;
        while (!pq2.empty()) {
