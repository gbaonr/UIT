...
int main()
{
    ...
    while (q--) {
        ...
        queue<string> open; // luu cac dinh can xet
        ...
        while (!open.empty()) { // trong khi van con dinh can xet
            ...
            cout << p << endl;
            cout << "level: " << level[p] << " " << level[d] << endl;
            if (p == d && level[p] != level[d]) { // neu dinh can xet la dinh ket thuc thi ket thuc + in ra duong di
