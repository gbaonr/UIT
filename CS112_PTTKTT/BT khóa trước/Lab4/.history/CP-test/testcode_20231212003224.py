...
parser.add_argument(
    "-I1", metavar="--input1", type=str, required=False, help="file containg code1"
)
parser.add_argument(
    "-I2", metavar="--input2", type=str, required=False, help="file containg code2"
)
parser.add_argument(
    "-C",
    metavar="--config",
...
parser.add_argument(
    "-N", metavar="--no_test", type=int, default=10, help="no of times to run test"
)
...
if __name__ == "__main__":
    ...
    try:
        ...
        for i in range(tc_nos):
            ...
            grp_args = {"grptype": grp_type, "idxfile": idx_out, "idxlen": idx_len}
        ...
        if stats:
            ...
            print()
            print("Code1 total time : %.5f sec" % (total_t1 / (tc_nos)))
            print("Code2 total time : %.5f sec" % (total_t2 / (tc_nos)))
            print()
            print("Max time taken by code1 : %.5f sec" % max_time, id_max)
            print()
